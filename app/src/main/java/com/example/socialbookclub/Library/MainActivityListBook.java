...
public class MainActivityListBook extends AppCompatActivity {
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(MainActivityListBook.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(MainActivityListBook.this);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        String thumbnail = "";
                        if (imageLinks != null) {
                            String thumbnail2 = imageLinks.optString("thumbnail");
                            thumbnail = "https";
                            thumbnail = thumbnail + thumbnail2.substring(4);
                        }
                        ...
                        AdapterLibrary adapter = new AdapterLibrary(bookArrayList, MainActivityListBook.this);

                        // below line is use to add linear layout
                        // manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(MainActivityListBook.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(MainActivityListBook.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivityListBook.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
